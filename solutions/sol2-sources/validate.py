...
"""
AES code adapted from: https://github.com/boppreh/aes/blob/master/aes.py
"""
...
for n in range(N):
    if AES(key).encrypt(plaintexts[n]) != ciphertexts[n]:
        print(f"Key is wrong! {hex(key)=}")

print(f"Key is correct!")
print(f"Key: {hex(key).upper().replace('X', 'x')}")
